...
<body class="bg-gray-100 dark:bg-gray-900 transition-colors dark:text-gray-200 duration-300">
    <div class="min-h-screen flex">
        ...
        <button id="mobileMenuButton" class="md:hidden fixed top-4 right-4 z-50 p-2 text-gray-600 dark:text-gray-300">
        ...
        <aside id="sidebar" class="bg-white dark:bg-gray-800 w-64 shadow-lg fixed h-full mobile-menu md:translate-x-0 z-40 transition-colors duration-300">
