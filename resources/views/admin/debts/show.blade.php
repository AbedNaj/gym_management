<x-admin title="{{ __('debts.SelectACustomer') }}">
    <section class="shadow-lg rounded-xl bg-white dark:bg-gray-800 p-6 max-w-xl mx-auto">
        <section class="space-y-4">
            ...
            <div class="space-y-3 border-b pb-4 border-gray-200 dark:border-gray-700">
                <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100">{{ __('debts.CustomerDetails') }}</h3>
                <div class="grid grid-cols-3 gap-4">
                    <dt class="text-gray-600 dark:text-gray-400">{{ __('debts.name') }}:</dt>
            ...
            @if($debts->isNotEmpty())
            <div class="space-y-4">
                <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100">{{ __('debts.CurrentDebtStatus') }}</h3>
                <div class="grid grid-cols-2 gap-4 mb-4">
                    <div class="border p-4 rounded-lg dark:border-gray-700">
                        <dt class="text-gray-600 dark:text-gray-400">{{ __('debts.DebtAmount') }}</dt>
                        <dd class="text-xl font-bold text-red-600 dark:text-red-400">
                            {{ number_format($debt_amount, 2) }}
                        </dd>
                    </div>
                    <div class="border p-4 rounded-lg dark:border-gray-700">
                        <dt class="text-gray-600 dark:text-gray-400">{{ __('debts.paidAmount') }}</dt>
