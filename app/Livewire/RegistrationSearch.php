...
class RegistrationSearch extends Component
{
    public $query = '';
    public $customers = [];
    ...
    public function fechData()
    {
        ...
        $this->datas =  registration::getStatusOptions();
    }
    ...
    public function updated($property)
    {
        if ($property === 'selectedValue') {
            ...
            $this->redirect(route('admin.registration.search', [
    ...
    {
        return view('livewire.registration-search');
    }
}
